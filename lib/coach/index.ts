...
20b. Rodada en grupeta: por defecto duration_minutes + entrada / rodada / vuelta, sin target_power ni target_hr. Si el grupo lleva un trabajo (pasadas, series), escribilo en description y en los bloques. Si no hay trabajo, no lo inventes. target_zone = "grupeta".
