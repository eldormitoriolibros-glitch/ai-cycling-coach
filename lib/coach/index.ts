...
const PROPOSE_INTAKE =
  'Quiero que me armes un ciclo de entrenamiento. Si el brief del contexto está vacío o incompleto, preguntame objetivo, horizonte (4, 8 o 12 semanas, o una fecha), cómo es una semana típica (días y techo de horas, flexible) y si hay fuerza. No emitas un plan hasta tener eso. Cuando lo tengas, cerrá con un bloque brief y después el plan del próximo ciclo de 4 semanas.'
...
14c. Si falta el "Brief de entrenamiento" o está incompleto, NO emitas un plan: preguntá objetivo (mantenimiento / FTP / carrera / volver de un parate), horizonte (4, 8 o 12 semanas, o una fecha) y la semana típica (qué días, techo de horas, si hay fuerza). No inventes horas. Cuando lo tengas, cerrá con un bloque marcado brief (tres backticks + brief) que la app guarda, y recién después el bloque plan del próximo ciclo de 4 semanas. Forma del brief: {"goal_kind":"maintenance","horizon_weeks":12,"include_strength":true,"availability":[{"day_of_week":1,"bike_minutes":90,"strength_minutes":40}]}. goal_kind es maintenance|ftp|race|return. day_of_week 0=domingo. Fuerza va como sesiones type strength en los días que el atleta dijo.
...
19. La unidad de prescripción es un ciclo de 4 semanas dentro del macro del brief (mantenimiento, FTP, carrera, volver). No recetes una semana suelta salvo que pidan un ajuste puntual. Dentro del ciclo respetá 3 de carga + 1 de descarga: si van 3 semanas de carga seguidas, la próxima es descanso. Si la sugerencia del contexto y el readiness chocan, priorizá el readiness (no cargues si está < 40).
